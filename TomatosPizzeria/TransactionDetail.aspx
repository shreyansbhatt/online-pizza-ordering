<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TransactionDetail.aspx.cs" Inherits="TransactionDetail" %>
...
<head>
    ...
    <div id="SuccessMessageDiv" class="alert alert-success" runat="server">
        Your order has been submitted.  If you have any questions, please call 630-766-2221.
        
    </div>
    <div id="ErrorMessageDiv" class="alert alert-warning" runat="server">
        Your order is unsuccessfull.  If you have any questions, please call 630-766-2221.
                        ...
                        <div class="col-md-8">
                            <div class="top-right">
                                ...
                                <ul class="login-div">
                                    ...
                                    <li class="LiLogin">
                                        <div id="SignInDiv" runat="server"><a href="Login.aspx?PageName=TransactionDetail.aspx"><span id="SpanSignIn" runat="server">sign in</span></a></div>
                                    </li>
                                    <li class="liReg">
                                ...
                                <div class="col-md-12">
                                    <div id="login-form">
                                        <div class="form-group">
                                            ...
                                            <asp:Label ID="resultOrderNumber" runat="server"></asp:Label>
                                        ...
                                        <div class="form-group" style="display: none;">
                                            ...
                                            <asp:Label ID="resultPaymentType" runat="server" Style="display: none;"></asp:Label>
                                            <%--<input type="text" value="Credit card No" required="required" class="form-control" onFocus="this.value=''" onBlur="(this.value=='')? this.value='Credit card No':this.value;">--%>
                                        </div>
                                        <div class="form-group" style="display: none;">
                                            <label>Transaction ID</label>
                                            <asp:Label ID="resultTransactionId" runat="server" Style="display: none;"></asp:Label>
                                            <%--<input type="text" value="Credit card No" required="required" class="form-control" onFocus="this.value=''" onBlur="(this.value=='')? this.value='Credit card No':this.value;">--%>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <asp:Label ID="resultTransactionDate" runat="server"></asp:Label>

                                        </div>

                                        <div class="form-group">

                                            <asp:Button ID="btnHome" runat="server" Text="Back To Home" CssClass="submit-btn" OnClick="btnHome_Click" />
