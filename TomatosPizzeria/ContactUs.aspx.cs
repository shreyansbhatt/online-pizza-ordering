    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        try
        {
            if (Page.IsValid == true)
            {
                ...
                objClsUserInformation.SendMail(string.Empty, "Contact Us Inquiry", string.Empty, string.Empty, string.Empty, 6, string.Empty, txtName.Text, txtEmail.Text, txtComments.Text, lstClsProductDetail,string.Empty,string.Empty,string.Empty,string.Empty);
