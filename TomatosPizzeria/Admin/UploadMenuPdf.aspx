<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UploadMenuPdf.aspx.cs" Inherits="Admin_UploadMenuPdf" %>
                    ...
                    <ul class="nav">
                        ...
                        <li class="open"><a href="javascript:;"><i class="fa fa-tint"></i><span>Files and Images</span> </a>
                            <ul class="sub-menu">
                                ...
                                <li class="active"><a href="UploadMenuPdf.aspx">
            ...
            <div class="main-panel">
                ...
                <div class="main-content">
                    <div class="panel mb25">
                        <div class="panel-heading border" style="font-size: medium; font-weight: bold;">Menu Pdf Upload</div>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-horizontal bordered-group" role="form">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <asp:FileUpload ID="fileUpload1" runat="server" Style="left: 151px;" />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <%-- <asp:Button ID="Button1" runat="server" Text="Upload" onclick="btnUpload_Click" CssClass="btn btn-info" Style="left: 161px;" />--%>
                                            <asp:LinkButton ID="lnkMenuFileName" runat="server" Text='<% Eval("tpc_value") %>' OnClick="lnkMenuFileName_Click" ForeColor="Blue" Font-Bold="true"></asp:LinkButton>
