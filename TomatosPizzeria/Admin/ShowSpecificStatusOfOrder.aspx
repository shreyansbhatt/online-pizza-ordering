<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ShowSpecificStatusOfOrder.aspx.cs" Inherits="Admin_ShowSpecificStatusOfOrder" %>
...
<title>ShowSpecificStatusOfOrder</title>
<head runat="server">
                    ...
                    <ul class="nav">
                        ...
                        <li class="open"><a href="javascript:;"><i class="fa fa-tint"></i><span>Orders</span> </a>
                            <ul class="sub-menu">
                                ...
                                <li class="active"><a href="OrderDetail.aspx">
                        ...
                        <div class="table-header">
                            <div class="col-md-6">
                                <div class="col-md-8 col-sm-6" style="width: 100px;">
                                    <div role="form">
                                        <div id="DivSearch">
                                            <asp:TextBox ID="txtSearch" placeholder="Search" CssClass="form-control" runat="server" onkeyup="SearchOrder();" ClientIDMode="Static" Width="387px" onfocus="this.placeholder=''" onblur="this.placeholder='Search'"></asp:TextBox>
                            ...
                            <div class="col-md-8 col-sm-6">
                                <div role="form">
                                    <div class="form-group" id="filterdiv">
                                        ...
                                        <asp:Button ID="BtnFilter" class="btn btn-info" runat="server" Text="Filter" OnClick="BtnFilter_Click" />
                                    ...
                                    <ContentTemplate>
                                        <asp:GridView ID="gvOrderInformation" runat="server" AutoGenerateColumns="false" AllowSorting="true" OnRowCommand="gvOrderInformation_RowCommand" OnSorting="gvOrderInformation_Sorting" class="table table-bordered table-striped datatable editable-datatable responsive align-middle bordered" PageSize="10" AllowPaging="true" OnRowDataBound="gvOrderInformation_RowDataBound">
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="UserName" SortExpression="UserName" HeaderStyle-Width="130px">
                                                    <ItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="StoreName" SortExpression="StoreName" HeaderStyle-Width="100px">
                                                    <ItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="Order Delivered Time"  HeaderStyle-Width="180px">
                                                    <ItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="Order Wish Time"  HeaderStyle-Width="180px">
                                                    <ItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="Order Status" SortExpression="od_order_status" ItemStyle-Height="40px" HeaderStyle-Width="180px">
                                                    <ItemTemplate>
