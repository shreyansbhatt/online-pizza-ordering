<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MenuItemSizeInformation.aspx.cs" Inherits="Admin_MenuItemSizeInformation" %>
...
<title>MenuItemSizeInformation</title>
<head>
    ...
    <script type="text/javascript">
        function Confirm() {
            ...
            if (confirm("Are you sure you want to delete Menu Item Size?")) {
                    ...
                    <ul class="nav">
                        ...
                        <li class="open"><a href="javascript:;"><i class="fa fa-tint"></i><span>Menu Details</span> </a>
                            <ul class="sub-menu">
                                ...
                                <li class="active"><a href="MenuItemSizeInformation.aspx">
                ...
                <header class="header navbar">
                    ...
                    <ul class="nav navbar-nav navbar-right hidden-xs">
                        <li><a href="javascript:;" data-toggle="dropdown">
                            ...
                            <span class="pull-left" onclick="ConfirmForLogOut();return false;">Log Out</span> </a></li>
                    </ul>
                </header>

                <div class="main-content">
                    <div class="panel">
                        <div class="panel-heading border" style="font-size: medium; font-weight: bold;">Menu Item Size Information</div>
                        <div class="table-header">
                            <div class="col-md-6">
                                <div class="col-md-8 col-sm-6" style="width: 100px;">
                                    <div role="form">
                                        <asp:Button ID="btnAddSize" class="btn btn-info" runat="server" Text="Add New Size" OnClick="btnAddSize_Click" />
                        ...
                        <div class="panel-body">
                            <asp:UpdatePanel ID="UpSizeInformation" runat="server">
                                <ContentTemplate>
                                    <asp:GridView ID="gvSizeInformation" runat="server" AutoGenerateColumns="false" AllowSorting="true" class="table table-bordered table-striped datatable editable-datatable responsive align-middle bordered" PageSize="10" AllowPaging="true" OnRowCommand="gvSizeInformation_RowCommand" OnSorting="gvSizeInformation_Sorting" OnRowDataBound="gvSizeInformation_RowDataBound">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Size Name" SortExpression="ProductSizeName">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblSizeName" runat="server" Text='<%# Eval("ProductSizeName") %>'></asp:Label>

                                                </ItemTemplate>
                                            </asp:TemplateField>

                                            <asp:TemplateField HeaderText="Size Description" SortExpression="Description">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblSizeDescription" runat="server" Text='<%# Eval("Description") %>'></asp:Label>

                                                </ItemTemplate>
                                            </asp:TemplateField>

                                            <asp:TemplateField HeaderText="Ingredient Detail">
                                                <ItemTemplate>
                                                    <asp:GridView ID="gvMenuItemSizeIngeredientInformation" runat="server" AutoGenerateColumns="false" AllowSorting="true" class="table table-bordered table-striped datatable editable-datatable responsive align-middle bordered" PageSize="5" AllowPaging="false">
                                            ...
                                            <asp:TemplateField HeaderText="Edit" HeaderStyle-Width="2%">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="lnkEdit" runat="server" CommandName="EditSize" CommandArgument='<%# Eval("SizeId")%>' Text="Edit"></asp:LinkButton>
                                                </ItemTemplate>
                                            </asp:TemplateField>

                                            <asp:TemplateField HeaderText="Delete" HeaderStyle-Width="3%">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="lnkDelete" runat="server" CommandName="DeleteSize" CommandArgument='<%# Eval("SizeId")%>' Text="Delete" OnClientClick="Confirm()"></asp:LinkButton>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        ...
                                        <PagerTemplate>
                                            <ul class="pagination pull-right">
                                                <asp:Button ID="btnFirst" runat="server" Text="First" CssClass="btn btn-info" CommandName="First" />

                                                <asp:Button ID="btnPrevious" runat="server" Text="Previous" CssClass="btn btn-info" CommandName="Previous" />

                                                <asp:Button ID="btnNext" runat="server" Text="Next" CssClass="btn btn-info" CommandName="Next" />

                                                <asp:Button ID="btnLast" runat="server" Text="Last" CssClass="btn btn-info" CommandName="Last" />

                                            </ul>
                                        </PagerTemplate>
                                        <EmptyDataTemplate>
                                            No Menu Item Size Found
                                        </EmptyDataTemplate>
                                    </asp:GridView>
                                </ContentTemplate>
                            </asp:UpdatePanel>
