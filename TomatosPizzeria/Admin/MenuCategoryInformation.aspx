<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MenuCategoryInformation.aspx.cs" Inherits="MenuCategoryInformation" %>
...
<title>MenuCategoryInformation</title>
<head>
...
<body style="background-color: #F0F0F0">
    <form runat="server">
        ...
        <div class="app layout-fixed-header">
                    ...
                    <ul class="nav">
                        ...
                        <li class="open"><a href="javascript:;"><i class="fa fa-tint"></i><span>Menu Details</span> </a>
                            <ul class="sub-menu">
                                ...
                                --%>
                                <li class="active"><a href="MenuCategoryInformation.aspx">
                ...
                <div class="main-content">
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            <asp:UpdatePanel ID="UpCategoryInformation" runat="server">
                                <ContentTemplate>
                                    <asp:GridView ID="gvCategoryInformation" runat="server" AutoGenerateColumns="false" AllowSorting="true" class="table table-bordered table-striped datatable editable-datatable responsive align-middle bordered" PageSize="10" AllowPaging="true" OnRowCommand="gvCategoryInformation_RowCommand" OnSorting="gvCategoryInformation_Sorting" OnRowDataBound="gvCategoryInformation_RowDataBound">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Sequence Number" SortExpression="SeqNo">
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Category Name" SortExpression="ProductCategoryName">
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Categoty Description" SortExpression="Description">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblCategotyDescription" runat="server" Text='<%# Eval("Description") %>' ToolTip='<%# Eval("Description") %>'></asp:Label>

                                                </ItemTemplate>
                                            </asp:TemplateField>

                                            <%--   <asp:TemplateField HeaderText="Category Parent" SortExpression="Parent">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblCategoryParent" runat="server" Text='<%# Eval("Parent") %>'></asp:Label>
                                            ...
                                            <%--                                            <asp:TemplateField HeaderText="Category Image">
                                                <ItemTemplate>
                                                    <asp:Image ID="ImgMenuCategoryImage" runat="server" Width="100px" Height="100px" ImageUrl='<%# Eval("ImageUrl") %>' />
                                            ...
                                            <asp:TemplateField HeaderText="Ingredient Detail">
                                                <ItemTemplate>
                                                    <asp:GridView ID="gvMenuIngeredientInformation" runat="server" AutoGenerateColumns="false" AllowSorting="true" class="table table-bordered table-striped datatable editable-datatable responsive align-middle bordered" PageSize="5" AllowPaging="false" OnRowCommand="gvCategoryInformation_RowCommand" OnSorting="gvCategoryInformation_Sorting">
                                            ...
                                            <asp:TemplateField HeaderText="Edit" HeaderStyle-Width="2%">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="lnkEdit" runat="server" CommandName="EditMenuCategory" CommandArgument='<%# Eval("ProductCategoryId")%>' Text="Edit"></asp:LinkButton>
                                                </ItemTemplate>
                                            </asp:TemplateField>

                                            <asp:TemplateField HeaderText="Delete" HeaderStyle-Width="3%">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="lnkDelete" runat="server" CommandName="DeleteMenuCategory" CommandArgument='<%# Eval("ProductCategoryId")%>' Text="Delete" OnClientClick="Confirm()"></asp:LinkButton>
                                                </ItemTemplate>
                                            </asp:TemplateField>
            ...
            <footer class="content-footer" style="width: 80%;">
