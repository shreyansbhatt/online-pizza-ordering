<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddDailySpecialOffer.aspx.cs" Inherits="Admin_AddDailySpecialOffer" EnableEventValidation="false" %>
...
<title>AddDailySpecialOffer</title>
<head runat="server">
            ...
            <div class="main-panel">
                ...
                <div class="main-content">
                    ...
                    <div class="panel mb25">
                        <div class="panel-heading border" style="font-size:medium;font-weight:bold;">Daily Speical Offer Information</div>
                                    ...
                                    <div class="form-horizontal bordered-group" role="form">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                <asp:DropDownList ID="DdlDay" runat="server" CssClass="form-control" AutoPostBack="false" AppendDataBoundItems="True">
                                                    <asp:ListItem Selected="True" Value="-1">Select Day</asp:ListItem>
                                                ...
                                                <asp:RequiredFieldValidator ID="rqDay" ForeColor="Red" Display="Dynamic" ControlToValidate="DdlDay" runat="server" InitialValue="-1" ErrorMessage="Select Day"></asp:RequiredFieldValidator>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">Prodcut2 Size</label>
                                            <div class="col-sm-10">

                                                <asp:DropDownList ID="DdlProduct2Size" runat="server" CssClass="form-control" AutoPostBack="false" AppendDataBoundItems="True">
                                                    <asp:ListItem Selected="True" Value="-1">Select Product2 Size</asp:ListItem>
                                                </asp:DropDownList>
                                                <%--<asp:RequiredFieldValidator ID="rqProduct2Size" ForeColor="Red" Display="Dynamic" ControlToValidate="DdlProduct2Size" runat="server" InitialValue="-1" ErrorMessage="Select Product2 Size"></asp:RequiredFieldValidator>--%>
                                            </div>
                                        </div>
                    ...
                    <asp:Button ID="btnAddDailySpecialOffer" CssClass="btn btn-info" runat="server" Text="Add Daily Special Offer" OnClick="btnAddDailySpecialOffer_Click" />
                    &nbsp;&nbsp;
