<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddIngredientInformation.aspx.cs" Inherits="Admin_AddIngredientInformation" %>
...
<title>AddIngredientInformation</title>
<head>
                        ...
                        <li><a href="DashBoard.aspx"><i class="fa fa-flask"></i><span>Dashboard</span> </a></li>
                         <li class="open"><a href="javascript:;"><i class="fa fa-tint"></i><span>Menu Details</span> </a>
                            <ul class="sub-menu">
                                ...
                                <li class="active"><a href="IngredientInformation.aspx"><asp:Image ImageUrl="~/Admin/images/Icon/Ingredient.png" Height="22px" Width="22px" runat="server"/><span> </span><span>Ingredients</span> </a></li>
            ...
            <div class="main-panel">
                ...
                <div class="main-content">
                    <div class="panel mb25">
                        <div class="panel-heading border" style="font-size: medium;font-weight:bold;">Ingredient Information</div>
                                    ...
                                    <div class="form-horizontal bordered-group" role="form">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                <asp:RequiredFieldValidator ID="rqIngredientName" runat="server" ControlToValidate="txtIngredientName" ErrorMessage="Ingredient Name Required" ForeColor="Red" ValidationGroup="V1"></asp:RequiredFieldValidator>
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">Ingredient Description</label>
                                            <div class="col-sm-10">
                                                <asp:TextBox ID="txtIngredientDescription" CssClass="form-control" runat="server" TextMode="MultiLine" Rows="10" ValidationGroup="V1"></asp:TextBox>
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">Ingredient Price</label>
                                            <div class="col-sm-10">
                                                <asp:TextBox ID="txtIngredientPrice" runat="server" CssClass="form-control"></asp:TextBox>
                                                <asp:RequiredFieldValidator ID="rqIngredientPrice" runat="server" ControlToValidate="txtIngredientPrice" ValidationGroup="V1" ErrorMessage="Ingredient Price Required" ForeColor="Red" ></asp:RequiredFieldValidator>
                                                <asp:RegularExpressionValidator ID="RegularExpressionValidator3" ControlToValidate="txtIngredientPrice" runat="server" ErrorMessage="Only Integers and Decimal values are allowed" ValidationExpression="((\d+)((\.\d{1,2})?))$" ForeColor="Red" Style="margin-left: -150px;" ValidationGroup="V1"></asp:RegularExpressionValidator>
                                            </div>
                                        </div>
                    ...
                    <asp:Button ID="btnAddIngredient" CssClass="btn btn-info"  runat="server" Text="Add Ingredient" OnClick="btnAddIngredient_Click" ValidationGroup="V1"/>
