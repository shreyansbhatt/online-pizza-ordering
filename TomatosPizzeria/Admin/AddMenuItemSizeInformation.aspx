<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddMenuItemSizeInformation.aspx.cs" Inherits="Admin_AddMenuItemSizeInformation" %>
...
<title>AddMenuItemSizeInformation</title>
<head>
        ...
        <div class="app layout-fixed-header">
                        ...
                        <li><a href="DashBoard.aspx"><i class="fa fa-flask"></i><span>Dashboard</span> </a></li>
                         <li class="open"><a href="javascript:;"><i class="fa fa-tint"></i><span>Menu Details</span> </a>
                            <ul class="sub-menu">
                                ...
                                <li class="active"><a href="MenuItemSizeInformation.aspx"><asp:Image ImageUrl="~/Admin/images/Icon//Menu Items.png" Height="22px" Width="22px" runat="server"/><span> </span><span>Product Sizes</span> </a></li>
            ...
            <div class="main-panel">
                ...
                <div class="main-content">
                                    ...
                                    <div class="form-horizontal bordered-group" role="form">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                <asp:RequiredFieldValidator ID="rqSizeName" ValidationGroup="V1" runat="server" ControlToValidate="txtSizeName" ErrorMessage="Size Name Required" ForeColor="Red"></asp:RequiredFieldValidator>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <asp:TextBox ID="txtSizeDescription" CssClass="form-control" runat="server" TextMode="MultiLine" Rows="10"></asp:TextBox>
                                        ...
                                        <div class="form-group" id="Ingreditndiv">
                                            ...
                                            <div class="col-sm-10" style="width:50%;">
                                                <asp:GridView ID="gvMenuSizeIngredientInformation" runat="server" AutoGenerateColumns="false" Style="margin-left: 220px;" class="table table-bordered table-striped datatable editable-datatable responsive align-middle bordered">
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Ingredient Price">
                                                            <ItemTemplate>
                                                                ...
                                                                <%--<asp:RegularExpressionValidator ID="RegularExpressionValidator3" ControlToValidate="txtIngredientPrice" runat="server" ErrorMessage="Only Integers and Decimal values are allowed" ValidationExpression="((\d+)((\.\d{1,2})?))$" ForeColor="Red" Style="margin-left: -130px;" ValidationGroup="V1"></asp:RegularExpressionValidator>--%>
                    ...
                    <asp:Button ID="btnAddSize" CssClass="btn btn-info"  runat="server" Text="Add Size" OnClick="btnAddSize_Click" ValidationGroup="V1"/>
