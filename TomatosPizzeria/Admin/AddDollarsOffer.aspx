<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddDollarsOffer.aspx.cs" Inherits="Admin_AddDollarsOffer" EnableEventValidation="false" %>
            ...
            <div class="main-panel">
                ...
                <div class="main-content">
                    ...
                    <div class="panel mb25">
                        <div class="panel-heading border" style="font-size:medium;font-weight:bold;">Dollars Offer Information</div>
                            ...
                            <div class="row no-margin">
                                <div class="col-lg-12">
                                    <div class="form-horizontal bordered-group" role="form">
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">Prodcut Size</label>
                                            <div class="col-sm-10">

                                                <asp:DropDownList ID="DdlProductSize" runat="server" CssClass="form-control" AutoPostBack="false" AppendDataBoundItems="True">
                                                    <asp:ListItem Selected="True" Value="-1">Select Product Size</asp:ListItem>
                                                </asp:DropDownList>
                                                <asp:RequiredFieldValidator ID="RqProductSize" ForeColor="Red" Display="Dynamic" ControlToValidate="DdlProductSize" runat="server" InitialValue="-1" ErrorMessage="Select Product Size"></asp:RequiredFieldValidator>
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">Off Amount</label>
                                            <div class="col-sm-10">
                    ...
                    <asp:Button ID="btnAddDollarsOffer" CssClass="btn btn-info" runat="server" Text="Add Dollars Offer" OnClick="btnAddDollarsOffer_Click" />
                    &nbsp;&nbsp;
