<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddFeastForFiveOffer.aspx.cs" Inherits="Admin_AddFeastForFiveOffer" EnableEventValidation="false"%>
...
<title>AddFeastForFiveOffer</title>
<head runat="server">
            ...
            <div class="main-panel">
                ...
                <div class="main-content">
                    ...
                    <div class="panel mb25">
                        <div class="panel-heading border" style="font-size:medium;font-weight:bold;">Feast For Five Offer Information</div>
                            ...
                            <div class="row no-margin">
                                <div class="col-lg-12">
                                    <div class="form-horizontal bordered-group" role="form">
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">Prodcut 1</label>
                                            <div class="col-sm-10">

                                                <asp:DropDownList ID="DdlProduct1" runat="server" CssClass="form-control" AutoPostBack="false" AppendDataBoundItems="True">
                                                    <asp:ListItem Selected="True" Value="-1">Select Product 1</asp:ListItem>
                                                </asp:DropDownList>
                                                <asp:RequiredFieldValidator ID="RqProduct1" ForeColor="Red" Display="Dynamic" ControlToValidate="DdlProduct1" runat="server" InitialValue="-1" ErrorMessage="Select Product1"></asp:RequiredFieldValidator>
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">Prodcut1 Size</label>
                                            <div class="col-sm-10">

                                                <asp:DropDownList ID="DdlProduct1Size" runat="server" CssClass="form-control" AutoPostBack="false" AppendDataBoundItems="True">
                                                    <asp:ListItem Selected="True" Value="-1">Select Product1 Size</asp:ListItem>
                                                </asp:DropDownList>
                                                <%--<asp:RequiredFieldValidator ID="RqProduct1Size" ForeColor="Red" Display="Dynamic" ControlToValidate="DdlProduct1Size" runat="server" InitialValue="-1" ErrorMessage="Select Product1 Size"></asp:RequiredFieldValidator>--%>
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">Product1 Quantity</label>
                                            <div class="col-sm-10">
                                                <asp:TextBox ID="txtProduct1Quantity" CssClass="form-control" runat="server"></asp:TextBox>
                                                <asp:RequiredFieldValidator ID="rqProduct1Quantity" runat="server" ControlToValidate="txtProduct1Quantity" ErrorMessage="Product1 Quantity Required" ForeColor="Red"></asp:RequiredFieldValidator>
                                                <asp:RegularExpressionValidator ID="RegularExpressionValidator1" ControlToValidate="txtProduct1Quantity" runat="server" ErrorMessage="Only Numbers allowed" ValidationExpression="\d+" ForeColor="Red" Style="margin-left: -150px;"></asp:RegularExpressionValidator>
                                            </div>
                                        </div>


                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">Prodcut 2</label>
                                            <div class="col-sm-10">

                                                <asp:DropDownList ID="DdlProduct2" runat="server" CssClass="form-control" AutoPostBack="false" AppendDataBoundItems="True">
                                                    <asp:ListItem Selected="True" Value="-1">Select Product2</asp:ListItem>
                                                </asp:DropDownList>
                                                <asp:RequiredFieldValidator ID="rqProduct2" ForeColor="Red" Display="Dynamic" ControlToValidate="DdlProduct2" runat="server" InitialValue="-1" ErrorMessage="Select Product2"></asp:RequiredFieldValidator>
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">Product2 Quantity</label>
                                            <div class="col-sm-10">
                                                <asp:TextBox ID="txtProduct2Quantity" CssClass="form-control" runat="server"></asp:TextBox>
                                                <asp:RequiredFieldValidator ID="rqProduct2Quantity" runat="server" ControlToValidate="txtProduct2Quantity" ErrorMessage="Product2 Quantity Required" ForeColor="Red"></asp:RequiredFieldValidator>
                                                <asp:RegularExpressionValidator ID="RegularExpressionValidator2" ControlToValidate="txtProduct2Quantity" runat="server" ErrorMessage="Only Numbers allowed" ValidationExpression="\d+" ForeColor="Red" Style="margin-left: -150px;"></asp:RegularExpressionValidator>
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">Prodcut 3</label>
                                            <div class="col-sm-10">

                                                <asp:DropDownList ID="DdlProduct3" runat="server" CssClass="form-control" AutoPostBack="false" AppendDataBoundItems="True">
                                                    <asp:ListItem Selected="True" Value="-1">Select Product3 </asp:ListItem>
                                                </asp:DropDownList>
                                                <asp:RequiredFieldValidator ID="rqProduct3" ForeColor="Red" Display="Dynamic" ControlToValidate="DdlProduct3" runat="server" InitialValue="-1" ErrorMessage="Select Product3"></asp:RequiredFieldValidator>
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">Product3 Quantity</label>
                                            <div class="col-sm-10">
                                                <asp:TextBox ID="txtProduct3Quantity" CssClass="form-control" runat="server"></asp:TextBox>
                                                <asp:RequiredFieldValidator ID="rqProduct3Quantity" runat="server" ControlToValidate="txtProduct3Quantity" ErrorMessage="Product3 Quantity Required" ForeColor="Red"></asp:RequiredFieldValidator>
                                                <asp:RegularExpressionValidator ID="RegularExpressionValidator4" ControlToValidate="txtProduct3Quantity" runat="server" ErrorMessage="Only Numbers allowed" ValidationExpression="\d+" ForeColor="Red" Style="margin-left: -150px;"></asp:RegularExpressionValidator>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <asp:TextBox ID="txtOfferAmount" CssClass="form-control" runat="server"></asp:TextBox>
                                                <asp:RequiredFieldValidator ID="rqOfferAmount" runat="server" ControlToValidate="txtOfferAmount" ErrorMessage="Offer Amount Required" ForeColor="Red"></asp:RequiredFieldValidator>
                                                <asp:RegularExpressionValidator ID="RegularExpressionValidator3" ControlToValidate="txtOfferAmount" runat="server" ErrorMessage="Only Integers and Decimal values are allowed" ValidationExpression="((\d+)((\.\d{1,2})?))$" ForeColor="Red" Style="margin-left: -130px;"></asp:RegularExpressionValidator>
                                            </div>
                                        </div>
                    ...
                    <asp:Button ID="btnAddFeastForFiveOffer" CssClass="btn btn-info" runat="server" Text="Add Feast For Five Offer" OnClick="btnAddFeastForFiveOffer_Click" />
                    &nbsp;&nbsp;
