<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddConfigKeyAndValues.aspx.cs" Inherits="Admin_AddConfigKeyAndValues" %>
...
<title>AddConfigKLeyAndValues</title>
<head>
                 ...
                 <nav role="navigation">
                    <ul class="nav">
                        ...
                        <li><a href="OfferDetail.aspx"><i class="fa fa-tint"></i><span>Offers</span> </a>
                           <%-- <ul class="sub-menu">
                                <li><a href="OfferDetail.aspx"><asp:Image ImageUrl="~/Admin/images/Icon/Offer.png" Height="22px" Width="22px" runat="server"/><span> </span><span>Offer Information</span> </a></li>
                            </ul>--%>
                        </li>
                        ...
                        <li class="open"><a href="javascript:;"><i class="fa fa-tint"></i><span>Misc. </span> </a>
                            <ul class="sub-menu">
                                ...
                                <li class="active"><a href="AddConfigKeyAndValues.aspx"><asp:Image ImageUrl="~/Admin/images/Icon/Miscellaneous & Configuration.png" Height="22px" Width="22px" runat="server"/><span> </span><span>Configuration Settings</span> </a></li>
            ...
            <div class="main-panel" style="background-color: #F0F0F0;">
                ...
                <div class="main-content">
                    <div class="panel mb25">
                        <div class="panel-heading border" style="font-size:medium;font-weight:bold;">Server Details</div>
                                    ...
                                    <div class="form-horizontal bordered-group" role="form">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                <asp:RequiredFieldValidator ID="rqTax" runat="server" ControlToValidate="txtUserName" ErrorMessage="UserName Required" ForeColor="Red"  ValidationGroup="V1"></asp:RequiredFieldValidator>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                <asp:RequiredFieldValidator ID="rqCarrier" runat="server" ControlToValidate="txtPassword" ErrorMessage="Password Required" ForeColor="Red" ValidationGroup="V1"></asp:RequiredFieldValidator>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtServerName" ErrorMessage="ServerName Required" ForeColor="Red" ValidationGroup="V1"></asp:RequiredFieldValidator>
                                            </div>
                                        </div>
                    ...
                    <div class="panel mb25">
                        <div class="panel-heading border" style="font-size:medium;font-weight:bold;">Admin Account Details</div>
                        <div class="panel-body">
                            <div class="row no-margin">
                                <div class="col-lg-12">
                                    <div class="form-horizontal bordered-group" role="form">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                <asp:RequiredFieldValidator ID="rqAdminEmail" runat="server" ControlToValidate="txtAdminEmail" ErrorMessage="UserName Required" ForeColor="Red"  ValidationGroup="V1"></asp:RequiredFieldValidator>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                <asp:RequiredFieldValidator ID="rqAdminPassword" runat="server" ControlToValidate="txtAdminPassword" ErrorMessage="Password Required" ForeColor="Red" ValidationGroup="V1"></asp:RequiredFieldValidator>
                                            </div>
                                        </div>
                    ...
                    <asp:Button ID="btnConfigValues" CssClass="btn btn-info" runat="server" Text="Add Config Values" OnClick="btnConfigValues_Click" ValidationGroup="V1"/>
