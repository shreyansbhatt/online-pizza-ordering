<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DayToDaySellingInformation.aspx.cs" EnableEventValidation="false" Inherits="Admin_DayToDaySellingInformation" %>
...
<title>DailySellingInformation</title>
<head runat="server">
        ...
        <div class="app layout-fixed-header">
                    ...
                    <ul class="nav">
                       ...
                       <li class="open"><a href="javascript:;"><i class="fa fa-tint"></i><span>Orders</span> </a>
                            <ul class="sub-menu">
                                ...
                                <li class="active"><a href="DayToDaySellingInformation.aspx"><asp:Image ImageUrl="~/Admin/images/Icon/Day to Day Sales.png" Height="22px" Width="22px" runat="server"/><span> </span><span>Daily Sales</span> </a></li>
            ...
            <div class="main-panel" style="background-color: #F0F0F0;">
                ...
                <div class="main-content">
                    <div class="panel">
                        <div class="panel-heading border" style="font-size:medium;font-weight:bold;">Daily Selling Information</div>
                        <div class="table-header">
                                    ...
                                    <div role="form">
                                        <div class="form-group">
                                            ...
                                            <asp:DropDownList ID="ddlShowData" CssClass="dropdown" Width="55px" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlShowData_SelectedIndexChanged">
                                                ...
                                                <asp:ListItem>15</asp:ListItem>  <asp:ListItem>20</asp:ListItem>
                                            </asp:DropDownList>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6 search-bar">
                                <div>
                                    <%-- <asp:TextBox ID="txtSearch" placeholder="Search" CssClass="form-control" runat="server" Style="margin-left: 70px;" onkeyup="SearchIngredient();" ClientIDMode="Static" Width="387px" onfocus="this.placeholder=''" onblur="this.placeholder='Search'"></asp:TextBox>
                            ...
                            <div class="col-md-8 col-sm-6">
                                <div role="form">
                                    <div class="form-group">
                                        ...
                                        <asp:Button ID="BtnFilter" class="btn btn-info" runat="server" Text="Filter" OnClick="BtnFilter_Click" Style="margin-left: 10px; height: 30px;margin-top:-2px;" />
                                        <asp:Button ID="btnReset" class="btn btn-info" runat="server" Text="Reset" OnClick="btnReset_Click" style="margin-left: 20px; height: 30px;margin-top:-2px;display:none;" />
                                    </div>
                                </div>
                            </div>
                            <div class="panel-body">
                                <asp:UpdatePanel ID="UpDayToDaySellingInformation" runat="server">
                                    <ContentTemplate>
                                        <asp:GridView ID="gvDayToDaySellingInformation" runat="server" AutoGenerateColumns="false" AllowSorting="true" class="table table-bordered table-striped datatable editable-datatable responsive align-middle bordered" PageSize="10" AllowPaging="true" OnRowCommand="gvDayToDaySellingInformation_RowCommand" OnSorting="gvDayToDaySellingInformation_Sorting" >
                                            ...
                                            <Columns>
                                              ...
                                              <%--  <asp:TemplateField Visible="false">
                                                ...
                                                <asp:TemplateField HeaderText="Date">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblOrderDate" runat="server" Text='<%# Eval("OrderPlaceString") %>'></asp:Label>

                                                    </ItemTemplate>
                                                </asp:TemplateField>

                                                <asp:TemplateField HeaderText="TotalAmount" SortExpression="TotalOrderAmount">
                                                    <ItemTemplate>
