<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MenuItemMakingMethodInformation.aspx.cs" Inherits="Admin_MenuItemMakingMethodInformation" %>
...
<title>MenuItemMakingMethodInformation</title>
<head>
    ...
    <script type="text/javascript">
        function Confirm() {
            ...
            if (confirm("Are you sure you want to delete Menu Item Making Mathod?")) {
        ...
        <div class="app layout-fixed-header">
                    ...
                    <ul class="nav">
                        ...
                        <li class="open"><a href="javascript:;"><i class="fa fa-tint"></i><span>Menu Details</span> </a>
                            <ul class="sub-menu">
                                ...
                                <li class="active"><a href="MenuItemMakingMethodInformation.aspx">
            ...
            <div class="main-panel" style="background-color: #F0F0F0;">
                ...
                <div class="main-content">
                    <div class="panel">
                        <div class="panel-heading border" style="font-size: medium; font-weight: bold;">Menu Item Making Method Information</div>
                        <div class="table-header">
                            <div class="col-md-6">
                                <div class="col-md-8 col-sm-6" style="width: 100px;">
                                    <div role="form">
                                        <asp:Button ID="btnAddMakingMethod" class="btn btn-info" runat="server" Text="Add New Making Method" OnClick="btnAddMakingMethod_Click" />

                                    </div>
                                </div>
                                <div id="DivSearch">
                                    <asp:TextBox ID="txtSearch" placeholder="Search" CssClass="form-control" runat="server" Width="250px" ClientIDMode="Static" onfocus="this.placeholder=''" onblur="this.placeholder='Search'"></asp:TextBox>
                                </div>
                            </div>
                        ...
                        <div class="panel-body">
                            <asp:UpdatePanel ID="UpMakingMethodInformation" runat="server">
                                <ContentTemplate>
                                    <asp:GridView ID="gvMakingMethodInformation" runat="server" AutoGenerateColumns="false" AllowSorting="true" class="table table-bordered table-striped datatable editable-datatable responsive align-middle bordered" PageSize="10" AllowPaging="true" OnRowCommand="gvMakingMethodInformation_RowCommand" OnSorting="gvMakingMethodInformation_Sorting">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField Visible="false">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblMakingMethodID" runat="server" Text='<%# Eval("ProductMakingMethodId") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>

                                            <asp:TemplateField HeaderText="Menu Item Making Method Name" SortExpression="ProductMakingMethodName">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblMenuItemMakingMethodName" runat="server" Text='<%# Eval("ProductMakingMethodName") %>'></asp:Label>
                                            ...
                                            <asp:TemplateField HeaderText="Edit" HeaderStyle-Width="2%">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="lnkEdit" runat="server" CommandName="EditMakingMethod" CommandArgument='<%# Eval("ProductMakingMethodId")%>' Text="Edit"></asp:LinkButton>
                                                </ItemTemplate>
                                            </asp:TemplateField>

                                            <asp:TemplateField HeaderText="Delete" HeaderStyle-Width="3%">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="lnkDelete" runat="server" CommandName="DeleteMakingMethod" CommandArgument='<%# Eval("ProductMakingMethodId")%>' Text="Delete" OnClientClick="Confirm()"></asp:LinkButton>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        ...
                                        <EmptyDataTemplate>
                                            No Menu Item Making Methods Found
                                        </EmptyDataTemplate>
                                    </asp:GridView>
                                </ContentTemplate>
                            </asp:UpdatePanel>
