<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddPizzaBaseTypeInformation.aspx.cs" Inherits="Admin_AddPizzaBaseTypeInformation" %>
...
<title>AddPizzaBaseTypeInformation</title>
<head>
        ...
        <div class="app layout-fixed-header">
                        ...
                        <li><a href="DashBoard.aspx"><i class="fa fa-flask"></i><span>Dashboard</span> </a></li>
                         <li class="open"><a href="javascript:;"><i class="fa fa-tint"></i><span>Menu Details</span> </a>
                            <ul class="sub-menu">
                                ...
                                <li class="active"><a href="PizzaBaseTypeInformation.aspx"><asp:Image ImageUrl="~/Admin/images/Icon/Pizza Base Type.png" Height="22px" Width="22px" runat="server"/><span> </span><span>Pizza Type</span> </a></li>
            ...
            <div class="main-panel">
                ...
                <div class="main-content">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-horizontal bordered-group" role="form">
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">Pizza Base Type Name</label>
                                            <div class="col-sm-10">
                                                <asp:TextBox ID="txtPizzaBaseTypeName" CssClass="form-control" runat="server"></asp:TextBox>
                                                <asp:RequiredFieldValidator ID="rqPizzaBaseTypeName" runat="server" ValidationGroup="V1" ControlToValidate="txtPizzaBaseTypeName" ErrorMessage="Pizza Base Type Name Required" ForeColor="Red"></asp:RequiredFieldValidator>
                                            </div>
                                        </div>
                    ...
                    <asp:Button ID="btnAddPizzaBaseType" CssClass="btn btn-info"  runat="server" Text="Add Pizza Base Type" ValidationGroup="V1" OnClick="btnAddPizzaBaseType_Click" />
