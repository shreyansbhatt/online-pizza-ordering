<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddConfigContactDetail.aspx.cs" Inherits="Admin_AddConfigContactDetail" %>

<html class="no-js">
<meta charset="utf-8">
<meta name="description" content="">
<meta name="viewport" content="width=device-width">
<title>AddConfigContactDetail</title>
<head>
                ...
                <div class="brand">
                  ...
                  <nav role="navigation">
                    <ul class="nav">
                        ...
                        <li><a href="jCustomerInformation.aspx"><i class="fa fa-tint"></i><span>Customers</span> </a>
                            <%--<ul class="sub-menu">
                        ...
                        <li class="open"><a href="javascript:;"><i class="fa fa-tint"></i><span>Misc. </span> </a>
                            <ul class="sub-menu">
                                ...
                                <li class="active"><a href="AddConfigContactDetail.aspx"><asp:Image ImageUrl="~/Admin/images/Icon/Contact.png" Height="22px" Width="22px" runat="server"/><span> </span><span>Contact Detail</span></a></li>
            ...
            <div class="main-panel">
                ...
                <div class="main-content">
                    <div class="panel mb25">
                        <div class="panel-heading border" style="font-size: medium; font-weight: bold;">Contact Details</div>
                                    ...
                                    <div class="form-horizontal bordered-group" role="form">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                <asp:RequiredFieldValidator ID="rqAddress" runat="server" ControlToValidate="txtAddress" ErrorMessage="Address Required" ForeColor="Red" ValidationGroup="Vg2"></asp:RequiredFieldValidator>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                <asp:RequiredFieldValidator ID="rqPhoneNo" runat="server" ControlToValidate="txtPhoneNo" ErrorMessage="Phone Number Required" ForeColor="Red" ValidationGroup="Vg2"></asp:RequiredFieldValidator>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                <asp:RequiredFieldValidator ID="rqFaxNo" runat="server" ControlToValidate="txtFaxNo" ErrorMessage="Fax Number Required" ForeColor="Red" ValidationGroup="Vg2"></asp:RequiredFieldValidator>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                <asp:RequiredFieldValidator ID="rqEmailId" runat="server" ControlToValidate="txtEmailId" ErrorMessage="Email id Required" ForeColor="Red" ValidationGroup="Vg2"></asp:RequiredFieldValidator>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <asp:Button ID="btnAddContactDetail" CssClass="btn btn-info" runat="server" Text="Add Contact Detail" OnClick="btnAddContactDetail_Click" ValidationGroup="Vg2" />
