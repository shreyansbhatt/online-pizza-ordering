<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SendNewsLatterInformation.aspx.cs" Inherits="Admin_SendNewsLatterInformation" %>
...
<title>SendNewsLetterInformation</title>
<head>
...
<script type="text/javascript">
    ...
    <%--<div id="UserAlreadyExistsDiv" class="alert alert-warning" runat="server">
        ...
        <div class="app layout-fixed-header">
                  ...
                  <nav role="navigation">
                   <ul class="nav">
                       ...
                       <li><a href="javascript:;"><i class="fa fa-tint"></i><span>Orders</span> </a>
                        ...
                        <li class="active"><a href="SendNewsLatterInformation.aspx"><i class="fa fa-tint"></i><span>Newsletters</span> </a>
                           <%-- <ul class="sub-menu">
            ...
            <div class="main-panel">
                ...
                <div class="main-content">
                    <label id="lblErrorMsg" forecolor="Red" style="color: green" runat="server"></label>
                    <div class="panel mb25">
                        <div class="panel-heading border" style="font-size: medium; font-weight: bold;">Newsletter Information</div>
                                    ...
                                    <div class="form-horizontal bordered-group" role="form">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                <asp:RequiredFieldValidator ID="rqSubject" runat="server" ValidationGroup="V1" ControlToValidate="txtSubject" ErrorMessage="Subject Required" ForeColor="Red"></asp:RequiredFieldValidator>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">Email Text</label>
                                            <div class="col-sm-10">
                                                <%-- <asp:TextBox ID="txtProductDescription" CssClass="form-control" runat="server" TextMode="MultiLine" Rows="10"></asp:TextBox>
                                                --%>
                                                <CKEditor:CKEditorControl ID="CKeditorDescription" BasePath="/ckeditor/" runat="server"></CKEditor:CKEditorControl>
                                               <%-- <asp:RequiredFieldValidator ID="rqDescription" runat="server" ValidationGroup="V1" ControlToValidate="CKeditorDescription" ErrorMessage="Email Body Required" ForeColor="Red"></asp:RequiredFieldValidator>
                                           --%> </div>
                                        </div>
                                         <div class="form-group">
                    ...
                    <asp:Button ID="btnSendEmail" CssClass="btn btn-info" runat="server" Text="Send Email To All Subscribe User" ValidationGroup="V1" OnClick="btnSendEmail_Click" />
                    &nbsp;&nbsp;
                    <asp:Button ID="btnCancel" CssClass="btn btn-info" runat="server" Text="Cancel" OnClick="btnCancel_Click" CausesValidation="false" Visible="false" />
                </div>
            </div>
            <br />
            <br />
