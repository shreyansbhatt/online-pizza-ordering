<%@ Page Language="C#" AutoEventWireup="true" CodeFile="IngredientInformation.aspx.cs" Inherits="Admin_IngredientInformation" %>
                    ...
                    <ul class="nav">
                        ...
                        <li class="open"><a href="javascript:;"><i class="fa fa-tint"></i><span>Menu Details</span> </a>
                            <ul class="sub-menu">
                                ...
                                <li class="active"><a href="IngredientInformation.aspx">
                    ...
                    <div class="panel">
                        ...
                        <div class="table-header">
                            ...
                            <div class="col-md-6 search-bar">
                                <%--<asp:TextBox ID="txtSearch" placeholder="Search" CssClass="form-control" runat="server" onkeyup="SearchIngredient();" ClientIDMode="Static" Width="387px" onfocus="this.placeholder=''" onblur="this.placeholder='Search'"></asp:TextBox>
                        ...
                        <div class="panel-body">
                            <asp:UpdatePanel ID="UpIngredientInformation" runat="server">
                                <ContentTemplate>
                                    <asp:GridView ID="gvIngredientInformation" runat="server" AutoGenerateColumns="false" AllowSorting="true" class="table table-bordered table-striped datatable editable-datatable responsive align-middle bordered" PageSize="10" AllowPaging="true" OnRowCommand="gvIngredientInformation_RowCommand" OnSorting="gvIngredientInformation_Sorting">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Description" SortExpression="Description">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblIngredientDescription" runat="server" Text='<%# Eval("Description") %>'></asp:Label>
                                            ...
                                            <asp:TemplateField HeaderText="Price" SortExpression="Price">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblIngredientPrice" runat="server" Text='<%# Eval("Price") %>'></asp:Label>
                                            ...
                                            <asp:TemplateField HeaderText="Edit" HeaderStyle-Width="2%">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="lnkEdit" runat="server" CommandName="EditIngredient" CommandArgument='<%# Eval("IngredientId")%>' Text="Edit"></asp:LinkButton>
                                                </ItemTemplate>
                                            </asp:TemplateField>

                                            <asp:TemplateField HeaderText="Delete" HeaderStyle-Width="3%">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="lnkDelete" runat="server" CommandName="DeleteIngredient" CommandArgument='<%# Eval("IngredientId")%>' Text="Delete" OnClientClick="Confirm()"></asp:LinkButton>
                                                </ItemTemplate>
                                            </asp:TemplateField>
