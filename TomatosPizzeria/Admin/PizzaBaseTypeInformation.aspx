<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PizzaBaseTypeInformation.aspx.cs" Inherits="Admin_PizzaBaseTypeInformation" %>
...
<title>PizzaBaseTypeInformation</title>
<head>
    ...
    <%-- <link rel="stylesheet" href="css/FontAwasome.css">
    ...
    <script type="text/javascript">
        function Confirm() {
            ...
            if (confirm("Are you sure you want to delete Pizza Base Type?")) {
        ...
        <div class="app layout-fixed-header">
                    ...
                    <ul class="nav">
                        ...
                        <li class="open"><a href="javascript:;"><i class="fa fa-tint"></i><span>Menu Details</span> </a>
                            <ul class="sub-menu">
                                ...
                                <li class="active"><a href="PizzaBaseTypeInformation.aspx">
                        ...
                        <li class="open"><a href="OfferDetail.aspx"><i class="fa fa-tint"></i><span>Offers</span> </a>
                            <%--<ul class="sub-menu">
            ...
            <div class="main-panel" style="background-color: #F0F0F0;">
                ...
                <div class="main-content">
                    <div class="panel">
                        <div class="panel-heading border" style="font-size: medium; font-weight: bold;">Pizza Base Type Information</div>
                        <div class="table-header">
                            <div class="col-md-6">
                                <div class="col-md-8 col-sm-6" style="width: 100px;">
                                    <div role="form">
                                        <asp:Button ID="btnAddPizzaBaseType" class="btn btn-info" runat="server" Text="Add New Pizza Base Type" OnClick="btnAddPizzaBaseType_Click" />
                        ...
                        <div class="panel-body">
                            <asp:UpdatePanel ID="UpPizzaBaseTypeInformation" runat="server">
                                <ContentTemplate>
                                    <asp:GridView ID="gvPizzaBaseTypeInformation" runat="server" AutoGenerateColumns="false" AllowSorting="true" class="table table-bordered table-striped datatable editable-datatable responsive align-middle bordered" PageSize="10" AllowPaging="true" OnRowCommand="gvPizzaBaseTypeInformation_RowCommand" OnSorting="gvPizzaBaseTypeInformation_Sorting">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Pizza Base Type Name" SortExpression="PizzaBaseTypeName">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblPizzaBaseTypeName" runat="server" Text='<%# Eval("PizzaBaseTypeName") %>'></asp:Label>
                                            ...
                                            <asp:TemplateField HeaderText="Edit" HeaderStyle-Width="2%">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="lnkEdit" runat="server" CommandName="EditPizzaBaseType" CommandArgument='<%# Eval("PizzaBaseTypeId")%>' Text="Edit"></asp:LinkButton>
                                                </ItemTemplate>
                                            </asp:TemplateField>

                                            <asp:TemplateField HeaderText="Delete" HeaderStyle-Width="3%">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="lnkDelete" runat="server" CommandName="DeletePizzaBaseType" CommandArgument='<%# Eval("PizzaBaseTypeId")%>' Text="Delete" OnClientClick="Confirm()"></asp:LinkButton>
                                                </ItemTemplate>
                                            </asp:TemplateField>
