<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddMenuItemMakingMethodInformation.aspx.cs" Inherits="Admin_AddMenuItemMakingMethodInformation" %>
...
<title>AddMenuItemMakingMethodInformation</title>
<head>
        ...
        <div class="app layout-fixed-header">
                        ...
                        <li><a href="DashBoard.aspx"><i class="fa fa-flask"></i><span>Dashboard</span> </a></li>
                         <li class="open"><a href="javascript:;"><i class="fa fa-tint"></i><span>Menu Details</span> </a>
                            <ul class="sub-menu">
                                ...
                                <li class="active"><a href="MenuItemMakingMethodInformation.aspx"><asp:Image ImageUrl="~/Admin/images/Icon/Menu Items.png" Height="22px" Width="22px" runat="server"/><span> </span><span>Making Method</span> </a></li>
                            </ul>
                        </li>
            ...
            <div class="main-panel">
                ...
                <div class="main-content">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-horizontal bordered-group" role="form">
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">Making Method Name</label>
                                            <div class="col-sm-10">
                                                <asp:TextBox ID="txtmakingMethodName" CssClass="form-control" runat="server"></asp:TextBox>
                                                <asp:RequiredFieldValidator ID="rqmakingMethodName" runat="server" ControlToValidate="txtmakingMethodName" ValidationGroup="V1" ErrorMessage="Menu Item Making Method Name Required" ForeColor="Red"></asp:RequiredFieldValidator>
                                            </div>
                                        </div>
                    ...
                    <asp:Button ID="btnAddMakingMethod" CssClass="btn btn-info" runat="server" Text="Add Making Method" OnClick="btnAddMakingMethod_Click" ValidationGroup="V1" />
