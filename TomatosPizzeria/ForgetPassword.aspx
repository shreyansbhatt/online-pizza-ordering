...
<head>
    ...
    <div id="SuccessMessageDiv" class="alert alert-success" runat="server">
        <strong>Success!</strong> Your password is sent to your registered email.
         <br />
        &nbsp;
    </div>
    <div id="ErrorMessageDiv" class="alert alert-warning" runat="server">
        <strong>Error!</strong> Provided Email id is not Registered with TomatosPizzeria.
    <br />
        &nbsp;
    </div>
                ...
                <div class="inner-wrapper">
                                ...
                                <ul class="login-div">
                                    <li class="dropdown" style="margin-left:3px;">
                                        <div id="EmailDiv" runat="server" style="display: none">
                                            <a class="dropdown-toggle" id="AccountAnchor" data-toggle="dropdown" href="#"><span id="SpanEmail" runat="server">My Account</span></a>
                                    ...
                                    <li class="LiLogin">
                                        <div id="SignInDiv" runat="server"><a href="Login.aspx?PageName=ForgetPassword.aspx"><span id="SpanSignIn" runat="server">sign in</span></a></div>
                                    </li>
                                    <li class="liReg">
                                ...
                                <div class="col-md-10">
                                    <div id="login-form">
                                        <div class="form-group">
                                            ...
                                            <%--<input type="text" value="enter your registered email" required="required" class="form-control" onfocus="this.value=''" onblur="(this.value=='')? this.value='enter your registered email':this.value;">--%>
                                            <asp:TextBox ID="txtEmailAddress" runat="server" onfocus="(this.value=='Email Address')? this.value='':this.value;" onblur="(this.value=='')? this.value='Email Address':this.value;" CssClass="form-control">Email Address</asp:TextBox>
                                        </div>
                                        <div class="form-group">
                                            <label></label>
                                            <%--<input type="submit" value="submit" class="submit-btn" onclick="reset - password.html">--%>
                                            <asp:Button ID="btnResetPassword" runat="server" Text="Submit" OnClick="btnResetPassword_Click" OnClientClick="return validate(); return false;" CssClass="submit-btn" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <footer>
                        <div class="footer">
                            ...
                            <div class="footer-bottom" id="ContctDiv"><span class="contact">
