...
<head>
    ...
    <script type="text/javascript">
        ...
        function HideLabel() {
           ...
           <%-- document.getElementById("<%=txtFirstName.ClientID%>").value = "First Name";
                ...
                document.getElementById("<%=txtEmailAddress.ClientID%>").value = "Email Address";
                 ...
                 document.getElementById("<%=rdbMale.ClientID%>").checked = false;
                document.getElementById("<%=rdbfemale.ClientID%>").checked = false;
                ...
                //document.getElementById("DdlState").value = "Illinois-(IL)";--%>
    ...
    <div id="SuccessMessageDiv" class="alert alert-success" runat="server">
        <strong>Success!</strong> Successfully Updated Details.
    </div>
    <div id="ErrorMessageDiv" class="alert alert-warning" runat="server" style="background-color: #ca3027; color: #ffffff; border-color: #ca3027;">
        <strong>Error!</strong> Unable to Update.Please try again.
    </div>
                        ...
                        <div class="col-md-8">
                            <div class="top-right">
                                ...
                                <ul class="login-div">
                                    ...
                                    <%-- <li> <a href="ResetPassword.aspx"><span>Reset Password</span></a></li>--%>
                            ...
                            <div class="register-div">
                                <div id="regiter-form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="txtPincode" runat="server" Style="color: black;" onfocus="(this.value=='Zip Code')? this.value='':this.value;" MaxLength="7" onblur="(this.value=='')? this.value='Zip Code':this.value;" CssClass="form-control" TabIndex="10">Zip Code</asp:TextBox>

                                    </div>
                                    <div class="form-group">
                                        <label></label>
                                        <%--<input type="submit" value="submit" class="submit-btn">--%>
                                        <asp:Button ID="btnEditProfile" runat="server" CssClass="submit-btn" Text="Submit" OnClick="btnEditProfile_Click" OnClientClick="return validate()" />
                                    </div>
                                </div>
                            </div>
                        </div>
