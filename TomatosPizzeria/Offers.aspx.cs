...
public partial class Offers : System.Web.UI.Page
{
    ...
    public void BindOffers()
    {
        ...
        dt = objClsOfferMaster.GetOfferDetailList();
        if (dt != null && dt.Rows.Count > 0)
        {
            rptOfferList.DataSource = dt;
    ...
    protected void btnSubscribe_Click(object sender, EventArgs e)
    {
        ...
        retMsg = objClsNewsLetterInformation.InsertNewsLetterDetail(txtEmailAddress.Text.Trim(), true, Convert.ToInt32(Session["UserId"]));
        if(retMsg=="SUCCESS")
        {
